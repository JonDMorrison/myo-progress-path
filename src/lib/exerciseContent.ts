/**
 * Reusable exercise content blocks
 * These can be used in database seeding or displayed in components
 */

export const MOUTH_TAPE_OVERNIGHT_INSTRUCTIONS = `## Overnight Mouth Taping
...
3. Use the same breathable tape you've been practicing with (Micropore or Surgical Tape)
