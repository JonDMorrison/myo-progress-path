...
export const ConsentStep = ({ onConsentChange }: ConsentStepProps) => {
  ...
  const loadConsent = async () => {
    ...
    By signing this agreement, you will be able to purchase a comprehensive myofunctional therapy program. This includes 24 weeks of exercises and depending on the tier purchased a brief evaluation done biweekly by a myofunctional therapist through video submissions and written feedback.
    ...
    In the circumstance a frenectomy should be performed, you will be referred to Dr Laura Caylor at Vedder Dental Clinic in Chilliwack. There will be an additional fee for the consultation with Dr Caylor and the frenectomy. The frenectomy plus follow up cost is approximately $1000, however, most dental insurance plans cover this under basic coverage at 80+%. More detailed estimates can be provided at Vedder Dental Clinic. If you choose not to have a frenectomy when advised, we cannot guarantee optimal outcomes for your myofunctional therapy, although you can still expect some improvement.
    ...
    I acknowledge that I have read and fully understand the treatment considerations presented in this form. I also understand that there are problems that can occur and that actual results may differ from the anticipated results. I acknowledge that I have been given the opportunity to discuss this form and ask any questions. I consent to the Myofunctional Therapy program provided by Matt Francisco, DDS and Samantha Raniak, RDH, OMT at Montrose Dental Centre. I understand that my program fee covers only Myofunctional Therapy, and that treatment provided by other dental or medical professionals is not included in the cost.`;
