      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            Update Weeks 3 & 4 with Therapist Content
          </CardTitle>
          <CardDescription>
            This will update Weeks 3 and 4 with the new exercise structure from the myofunctional therapist's PDF.
        ...
        <CardContent className="space-y-4">
          <div className="bg-muted p-4 rounded-lg space-y-2">
            ...
            <ul className="list-disc list-inside space-y-1 text-sm">
              <li>5 exercises per week: Lingual Palatal Suction, Tongue Points, Cheek Puffs, Belly Breathing, Elastic Hold</li>
              <li>Frequency and duration tracking (e.g., "2x/day", "2 minutes")</li>
              <li>Completion targets (28 sessions for active, 14 for passive/breathing)</li>
