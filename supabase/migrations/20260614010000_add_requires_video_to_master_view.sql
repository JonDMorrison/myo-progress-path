...
--
-- Note: this migration is idempotent. The column was already added to the
-- prod view in a prior session via Supabase MCP; checking in the file so
-- the repo's migrations history stays consistent with prod state.
