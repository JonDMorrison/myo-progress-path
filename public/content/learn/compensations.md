# Compensations to Limit

In this context, **compensations** are the result of stronger neck, face, and oral muscles taking over for muscles that are underdeveloped. To retrain these underdeveloped muscles, it is very important to recognize and limit compensations. Compensations will need to be evaluated and controlled **before your tongue tie release is approved**.

This article is for **educational purposes only**—to help you understand what compensations look like. Your therapist will provide specific guidance on exercises to address these patterns.
...
**Why it happens:** The jaw moves forward to compensate for weak posterior (back) tongue muscles that should be doing the work.
